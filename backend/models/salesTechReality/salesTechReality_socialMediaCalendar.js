...
const socialMediaPostSchema = new mongoose.Schema({
  ...
  uploadedLinks: [{
    ...
    addedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'salesTechReality_Employee' },
    addedAt: { type: Date, default: Date.now },
  }],
  assignedTo: [{ type: mongoose.Schema.Types.ObjectId, ref: 'salesTechReality_Employee' }],
}, { timestamps: true });
...
const SocialMediaCalendar = mongoose.model('salesTechReality_SocialMediaCalendar', socialMediaCalendarSchema);
