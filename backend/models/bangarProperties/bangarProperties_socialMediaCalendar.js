...
const socialMediaPostSchema = new mongoose.Schema({
  ...
  uploadedLinks: [{
    ...
    addedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'bangarProperties_Employee' },
    addedAt: { type: Date, default: Date.now },
  }],
  assignedTo: [{ type: mongoose.Schema.Types.ObjectId, ref: 'bangarProperties_Employee' }],
}, { timestamps: true });

const socialMediaCalendarSchema = new mongoose.Schema({
  client: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'bangarProperties_Client',
    required: true,
  },
  project: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'bangarProperties_Project',
    default: null,
  },
...
const SocialMediaCalendar = mongoose.model('bangarProperties_SocialMediaCalendar', socialMediaCalendarSchema);
