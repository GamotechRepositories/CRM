...
const socialMediaPostSchema = new mongoose.Schema({
  ...
  uploadedLinks: [{
    ...
    addedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'mahaProperties_Employee' },
    addedAt: { type: Date, default: Date.now },
  }],
  assignedTo: [{ type: mongoose.Schema.Types.ObjectId, ref: 'mahaProperties_Employee' }],
}, { timestamps: true });
...
const SocialMediaCalendar = mongoose.model('mahaProperties_SocialMediaCalendar', socialMediaCalendarSchema);
