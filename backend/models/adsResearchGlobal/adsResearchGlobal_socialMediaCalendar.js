...
const socialMediaPostSchema = new mongoose.Schema({
  ...
  uploadedLinks: [{
    ...
    addedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'adsResearchGlobal_Employee' },
    addedAt: { type: Date, default: Date.now },
  }],
  assignedTo: [{ type: mongoose.Schema.Types.ObjectId, ref: 'adsResearchGlobal_Employee' }],
}, { timestamps: true });

const socialMediaCalendarSchema = new mongoose.Schema({
  client: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'adsResearchGlobal_Client',
    required: true,
  },
  project: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'adsResearchGlobal_Project',
    default: null,
  },
...
const SocialMediaCalendar = mongoose.model('adsResearchGlobal_SocialMediaCalendar', socialMediaCalendarSchema);
