...
import Client from '../../models/mahaProperties/mahaProperties_client.js';
import Project from '../../models/mahaProperties/mahaProperties_project.js';
import Billing from '../../models/mahaProperties/mahaProperties_billing.js';
...
export const createClient = async (req, res) => {
  try {
    ...
    const newClient = new Client({
      ...
      date,
      clientType,
      clientCategory: clientCategory || 'Property',
