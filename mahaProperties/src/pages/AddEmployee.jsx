    ...
    <div className='p-6 md:p-8 w-full'>
      ...
      <form onSubmit={handleSubmit} className='space-y-6'>
        <Section title='1. Basic Information'>
          <Field label='Employee ID'><input name='employeeCode' value={form.employeeCode} onChange={handleChange} className={inputClass} placeholder='Auto-assigned (e.g. EMP30001)' /></Field>
